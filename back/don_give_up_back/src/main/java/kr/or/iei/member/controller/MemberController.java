...
public class MemberController {
	...
	// 회원 프로필(이미지) 수정
	@PostMapping("/profile")
	public ResponseEntity<ResponseDTO> updateProfile(int memberNo, // 회원번호
	...
	public ResponseEntity<ResponseDTO> checkPw(@RequestBody Member member) {
		ResponseDTO res = new ResponseDTO(HttpStatus.INTERNAL_SERVER_ERROR, "기존 비밀번호 확인중, 오류가 발생하였습니다.", false,
				"error");
	...
	public ResponseEntity<ResponseDTO> selectDonationHistory(@PathVariable int memberNo, @RequestParam int reqPage,
	...
	public ResponseEntity<ResponseDTO> selectWalletHistory(@PathVariable int memberNo, @RequestParam String filter,
			@RequestParam int reqPage, @RequestParam String startDate, @RequestParam String endDate) {

		ResponseDTO res = new ResponseDTO(HttpStatus.INTERNAL_SERVER_ERROR, "조회 중 오류가 발생하였습니다.", false, "error");

		try {
			HashMap<String, Object> walletMap = service.selectWalletHistory(memberNo, filter, reqPage, startDate,
					endDate);
	...
	public ResponseEntity<ResponseDTO> selectSurveyHistory(@PathVariable int memberNo) {
		ResponseDTO res = new ResponseDTO(HttpStatus.INTERNAL_SERVER_ERROR, "설문조사 내역 조회 중 오류가 발생하였습니다.", false,
				"error");
		try {
